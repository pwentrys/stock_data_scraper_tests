...
window.WebComponents = window.WebComponents || {}, function (e) {
        ...
        enqueue: function (e) {
            ...
            switch (e.stopImmediatePropagation(), e.type) {
                ...
                case"DOMNodeInserted":
                    var s, d, o = e.relatedNode, m = e.target;
                    "DOMNodeInserted" === e.type ? (s = [m], d = []) : (s = [], d = [m]);
                    var f = m.previousSibling, p = m.nextSibling, r = c("childList", o);
                    r.addedNodes = s, r.removedNodes = d, r.previousSibling = f, r.nextSibling = p, i(o, function (e) {
    ...
    var u = "import", l = Boolean(u in document.createElement("link")), m = Boolean(window.ShadowDOMPolyfill), f = function (e) {
    ...
    var a = e.path, s = e.rootDocument, d = e.flags, c = e.isIE, u = e.IMPORT_LINK_TYPE, l = "link[rel=" + u + "]", m = {
        documentSelectors: l,
    ...
    e.parser = m, e.IMPORT_SELECTOR = l
}), HTMLImports.addModule(function (e) {
    function t(e) {
        return n(e, i)
    }
    ...
    function o(e, t) {
        ...
        o.setAttribute("href", t), n.baseURI || Object.defineProperty(n, "baseURI", {value: t});
        var r = n.createElement("meta");
        return r.setAttribute("charset", "utf-8"), n.head.appendChild(r), n.head.appendChild(o), n.body.innerHTML = e, window.HTMLTemplateElement && HTMLTemplateElement.bootstrap && HTMLTemplateElement.bootstrap(n), n
    }

    var r = e.flags, i = e.IMPORT_LINK_TYPE, a = e.IMPORT_SELECTOR, s = e.rootDocument, d = e.Loader, c = e.Observer, u = e.parser, l = {
        documents: {},
        ...
        loaded: function (e, n, i, a, s) {
            if (r.load && console.log("loaded", e, n), n.__resource = i, n.__error = a, t(n)) {
                var d = this.documents[e];
                void 0 === d && (d = a ? null : o(i, s || e), d && (d.__importLink = n, this.bootDocument(d)), this.documents[e] = d), n["import"] = d
            }
            u.parseNext()
        },
    ...
    }, m = new d(l.loaded.bind(l), l.loadedAll.bind(l));
    ...
    function d(e) {
        e.__upgraded__ && (e.attachedCallback || e.detachedCallback) && !e.__attached && m(e) && (e.__attached = !0, e.attachedCallback && e.attachedCallback())
    }
    ...
    function l(e) {
        e.__upgraded__ && (e.attachedCallback || e.detachedCallback) && e.__attached && !m(e) && (e.__attached = !1, e.detachedCallback && e.detachedCallback())
    }
    ...
    }, e.watchShadow = f, e.upgradeDocumentTree = b, e.upgradeSubtree = o, e.upgradeAll = t, e.attachedNode = r, e.takeRecords = h
}), CustomElements.addModule(function (e) {
    function t(t) {
    ...
    function f(e, t) {
        ...
        var o;
        return t ? (o = f(e), o.setAttribute("is", t), o) : (o = M(e), e.indexOf("-") >= 0 && w(o, HTMLElement), o)
    }
    ...
    h = Object.__proto__ || _ ? function (e, t) {
        ...
        return !1
    }, document.registerElement = t, document.createElement = f, document.createElementNS = m, Node.prototype.cloneNode = p, e.registry = y, e["instanceof"] = h, e.reservedTagList = E, e.getRegisteredDefinition = c, document.register = document.registerElement
}), function (e) {
    function t() {
