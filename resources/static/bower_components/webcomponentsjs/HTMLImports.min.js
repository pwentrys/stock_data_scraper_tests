...
"undefined" == typeof WeakMap && !function () {
        ...
        enqueue: function (e) {
            ...
            switch (e.stopImmediatePropagation(), e.type) {
                ...
                case"DOMNodeInserted":
                    ...
                    var m = h.previousSibling, p = h.nextSibling, o = c("childList", n);
                    o.addedNodes = s, o.removedNodes = d, o.previousSibling = m, o.nextSibling = p, i(n, function (e) {
    ...
    function i(e, t) {
        ...
        if (d)for (var c, u = 0; d > u && (c = i[u]); u++)a(c) ? n.call(c, {target: c}) : (c.addEventListener("load", n), c.addEventListener("error", n)); else r()
    }
    ...
    var t = /(url\()([^)]*)(\))/g, r = /(@import[\s]+(?!url\())([^;]*)(;)/g, n = {
        resolveUrlsInStyle: function (e) {
            ...
            var o = this.replaceUrls(e, n, t);
            return o = this.replaceUrls(o, n, r)
        }, replaceUrls: function (e, t, r) {
            return e.replace(r, function (e, r, n, o) {
                var i = n.replace(/["']/g, "");
                return t.href = i, i = t.href, r + "'" + i + "'" + o
            })
        }
    };
    e.path = n
    ...
    var t = {
        async: !0, ok: function (e) {
            ...
            return (e.flags.debug || e.flags.bust) && (r += "?" + Math.random()), i.open("GET", r, t.async), i.addEventListener("readystatechange", function () {
                if (4 === i.readyState) {
                    var e = i.getResponseHeader("Location"), r = null;
                    if (e)var r = "/" === e.substr(0, 1) ? location.origin + e : e;
                    n.call(o, !t.ok(i) && i, i.response || i.responseText, r)
                }
            }), i.send(), i
    ...
    function n(e, t) {
        var r = document.implementation.createHTMLDocument(i);
        r._URL = t;
        var n = r.createElement("base");
        n.setAttribute("href", t), r.baseURI || Object.defineProperty(r, "baseURI", {value: t});
        var o = r.createElement("meta");
        return o.setAttribute("charset", "utf-8"), r.head.appendChild(o), r.head.appendChild(n), r.body.innerHTML = e, window.HTMLTemplateElement && HTMLTemplateElement.bootstrap && HTMLTemplateElement.bootstrap(r), r
    }
    ...
    var o = e.flags, i = e.IMPORT_LINK_TYPE, a = e.IMPORT_SELECTOR, s = e.rootDocument, d = e.Loader, c = e.Observer, u = e.parser, l = {
        ...
        loaded: function (e, r, i, a, s) {
            if (o.load && console.log("loaded", e, r), r.__resource = i, r.__error = a, t(r)) {
                var d = this.documents[e];
                void 0 === d && (d = a ? null : n(i, s || e), d && (d.__importLink = r, this.bootDocument(d)), this.documents[e] = d), r["import"] = d
            }
            u.parseNext()
        },
    ...
    }, h = new d(l.loaded.bind(l), l.loadedAll.bind(l));
