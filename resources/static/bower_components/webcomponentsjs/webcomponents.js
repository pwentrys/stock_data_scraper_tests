...
(function (scope) {
    ...
    if (!flags.noOpts) {
        ...
        if (flags.log) {
            var parts = flags.log.toString().split(",");
            flags.log = {};
...
if (WebComponents.flags.shadow) {
    ...
    (function (scope) {
        ...
        function NodeList(args) {
            this.length = (args && args.length) ? args.length : 0;
            nonEnum(this, "length");
        }
        ...
        function wrapNodeList(list) {
            ...
            var wrapperList = new NodeList(list.length);
...
(function (global) {
    ...
    function MutationRecord(type, obj) {
        this.type = type;
        if (obj.target) {
            this.target = obj.target;
            this.addedNodes = obj.addedNodes.slice();
            this.removedNodes = obj.removedNodes.slice();
            this.previousSibling = obj.previousSibling;
            this.nextSibling = obj.nextSibling;
            this.attributeName = obj.attributeName;
            this.attributeNamespace = obj.attributeNamespace;
    ...
    function copyMutationRecord(original) {
        return new MutationRecord(original.type, original);
        /*
