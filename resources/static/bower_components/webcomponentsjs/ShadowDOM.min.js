...
"undefined" == typeof WeakMap && !function () {
    ...
    var M = e.wrappers.EventTarget, T = e.wrappers.NodeList, O = e.TreeScope, L = e.assert, j = e.defineWrapGetter, N = e.enqueueMutation, _ = e.getTreeScope, C = e.isWrapper, D = e.mixin, H = e.registerTransientObservers, x = e.registerWrapper, R = e.setTreeScope, P = e.unsafeUnwrap, W = e.unwrap, A = e.unwrapIfNeeded, I = e.wrap, k = e.wrapIfNeeded, F = e.wrappers, B = !1, U = document.importNode, q = window.Node.prototype.cloneNode, V = window.Node, G = window.DocumentFragment, X = (V.prototype.appendChild, V.prototype.compareDocumentPosition), z = V.prototype.insertBefore, K = V.prototype.removeChild, Y = V.prototype.replaceChild, Z = /Trident|Edge/.test(navigator.userAgent), $ = Z ? function (e, t) {
        try {
            K.call(e, t)
        } catch (n) {
    ...
    function p(n, r, o, i, a) {
        ...
        if (c instanceof j)s = S.call(c, i); else {
    ...
    function d(n, r, o, i, a) {
        ...
        if (c instanceof j)s = T.call(c, i, a); else {
    ...
    function f(n, r, o, i, a) {
        var s, c = g(this), u = m(this).root;
        if (u instanceof e.wrappers.ShadowRoot)return l(this, r, o, n, i, a);
        if (c instanceof j)s = L.call(c, i, a); else {
            if (!(c instanceof N))return l(this, r, o, n, i, a);
            s = O.call(c, i, a)
        }
        return t(s, r, o, !1)
    ...
    }), m = w[0], g = h.prototype[m], v = new WeakMap;
    r.prototype = Object.create(a.prototype), l(r.prototype, {
        createShadowRoot: function () {
            var t = new f.ShadowRoot(this);
            d(this).polymerShadowRoot_ = t;
            var n = e.getRendererForHost(this);
            return n.invalidate(), t
        }, get shadowRoot() {
            return d(this).polymerShadowRoot_ || null
        }, setAttribute: function (e, r) {
            var o = d(this).getAttribute(e);
            d(this).setAttribute(e, r), n(this, e, o), t(this, e)
        }, removeAttribute: function (e) {
            var r = d(this).getAttribute(e);
            d(this).removeAttribute(e), n(this, e, r), t(this, e)
        }, matches: function (e) {
            return g.call(d(this), e)
        }, get classList() {
            var e = v.get(this);
            return e || (e = d(this).classList, e.ownerElement_ = this, v.set(this, e)), e
        }, get className() {
    ...
    }), h.prototype.webkitCreateShadowRoot && (r.prototype.webkitCreateShadowRoot = r.prototype.createShadowRoot), l(r.prototype, o), l(r.prototype, i), l(r.prototype, s), l(r.prototype, c), p(h, r, document.createElementNS(null, "x")), e.invalidateRendererBasedOnAttribute = t, e.matchesNames = w, e.wrappers.Element = r
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(e) {
        switch (e) {
